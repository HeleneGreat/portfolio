...
<?php require('class/fakeBdd.php'); ?>

<footer id="pied" class="bg-bleu">
        <div class="container">
            <div class="row py-xl-4">
                <div class="col col-lg-6 mx-auto">
                    <ul class="list-inline text-center yclair row justify-content-between m-3">
                        <li class="list-inline-item"><a href="detail-portfolio.php?id=<?= $allPortfolios[0]->getId(); ?>">Mon dernier projet</a></li>
